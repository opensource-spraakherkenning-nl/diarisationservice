...
SYSTEM_ID = "diarisationservice"
#System name, the way the system is presented to the world
SYSTEM_NAME = "Speaker Diarisation Service"

#An informative description for this system (this should be fairly short, about one paragraph, and may not contain HTML)
SYSTEM_DESCRIPTION = "A speaker diarisation service powered by PyAnnote"
...
class RTTMFormat(CLAMMetaData):
    attributes = {}
    name = "Rich Transcription Time Marked File"
    mimetype = "text/plain"

CUSTOM_FORMATS = [ RTTMFormat]
...
#
COMMAND = WEBSERVICEDIR + "/diarisationservice_wrapper.py $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"
...
PARAMETERS =  [
    ('Global', [
        ...
        IntegerParameter(id='minspeakers',name="Minimum speakers", description="Minimum number of speakers (this helps diarization)"),
        IntegerParameter(id='maxspeakers',name="Maximum speakers", description="Minimum number of speakers (this helps diarization)"),
    ])
]
